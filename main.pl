...
askable(t(бюджет(_))).
askable(t(дедлайн(_))).
askable(t(уровень_команды(_))).
askable(t(требования_к_качеству(_))).
askable(t(взаимодействие_с_клиентом(_))).

askable(бюджет(_)).
askable(дедлайн(_)).
askable(уровень_команды(_)).
askable(требования_к_качеству(_)).
askable(взаимодействие_с_клиентом(_)).
